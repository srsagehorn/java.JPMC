...
//                Walk or eat potion?
            if (potionChoice.toLowerCase() == "b") {
                if (gold >= 4) {
                    gold = gold - 4;
                    potions++;
                    System.out.println("After purchasing the potion, you now have " + gold + " gold and " + potions +  " potions.");
            }
            if(potionChoice.toLowerCase() == "t") {
                if (potions > 0 && hHealthPts + 2 <= potionsMax) {
                    potions--;
                    hHealthPoints = hHealthPoints + 2;
                    System.out.println("After taking the potion, you now have " + hHealthPoints + " hp and " + potions +  " potions left.");
                    whatNext();
                }
                else {
